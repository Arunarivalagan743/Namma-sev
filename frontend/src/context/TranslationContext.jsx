...
const STATIC_TRANSLATIONS = {
  en: {
    ...
    stayUpdatedCalendar: 'Stay updated with all events, meetings, schemes, and works in your panchayat',
    'Stay updated with all events, meetings, schemes, and works in your panchayat': 'Stay updated with all events, meetings, schemes, and works in your panchayat',
    calendar: 'Calendar',
    Calendar: 'Calendar',
    list: 'List',
    List: 'List',
    ...
    allUpcomingActivities: 'All Upcoming Activities',
    'All Upcoming Activities': 'All Upcoming Activities',
    'upcoming activities': 'upcoming activities',
    clearSelection: 'Clear Selection',
    'Clear Selection': 'Clear Selection',
    clickDateToSee: 'Click on a date to see all activities',
    'Click on a date to see all activities': 'Click on a date to see all activities',
    noUpcomingActivities: 'No Upcoming Activities',
    'No Upcoming Activities': 'No Upcoming Activities',
    checkBackLater: 'Check back later for new events and updates',
    'Check back later for new events and updates': 'Check back later for new events and updates',
    // Month Names
    'January': 'January',
    'February': 'February',
    'March': 'March',
    ...
    'Scheme Deadlines': 'Scheme Deadlines',
    'Works': 'Works',
    'Polls': 'Polls',
    'Event': 'Event',
    'Poll': 'Poll',
  ...
  ta: {
    ...
    'ACTIVITY CALENDAR': 'செயல்பாட்டு நாட்காட்டி',
    communityCalendar: 'சமூக நாட்காட்டி',
    'Community Calendar': 'சமூக நாட்காட்டி',
    stayUpdatedCalendar: 'உங்கள் ஊராட்சியில் நடக்கும் அனைத்து நிகழ்வுகள், கூட்டங்கள், திட்டங்கள் மற்றும் பணிகளுடன் புதுப்பித்த நிலையில் இருங்கள்',
    'Stay updated with all events, meetings, schemes, and works in your panchayat': 'உங்கள் ஊராட்சியில் நடக்கும் அனைத்து நிகழ்வுகள், கூட்டங்கள், திட்டங்கள் மற்றும் பணிகளுடன் புதுப்பித்த நிலையில் இருங்கள்',
    calendar: 'நாட்காட்டி',
    Calendar: 'நாட்காட்டி',
    list: 'பட்டியல்',
    List: 'பட்டியல்',
    ...
    'Upcoming Activities': 'வரவிருக்கும் செயல்பாடுகள்',
    allUpcomingActivities: 'அனைத்து வரவிருக்கும் செயல்பாடுகள்',
    'All Upcoming Activities': 'அனைத்து வரவிருக்கும் செயல்பாடுகள்',
    'upcoming activities': 'வரவிருக்கும் செயல்பாடுகள்',
    clearSelection: 'தேர்வை நீக்கு',
    'Clear Selection': 'தேர்வை நீக்கு',
    clickDateToSee: 'அனைத்து செயல்பாடுகளையும் பார்க்க ஒரு தேதியைக் கிளிக் செய்யவும்',
    'Click on a date to see all activities': 'அனைத்து செயல்பாடுகளையும் பார்க்க ஒரு தேதியைக் கிளிக் செய்யவும்',
    noUpcomingActivities: 'வரவிருக்கும் செயல்பாடுகள் இல்லை',
    'No Upcoming Activities': 'வரவிருக்கும் செயல்பாடுகள் இல்லை',
    checkBackLater: 'புதிய நிகழ்வுகள் மற்றும் புதுப்பிப்புகளுக்கு பின்னர் பார்க்கவும்',
    'Check back later for new events and updates': 'புதிய நிகழ்வுகள் மற்றும் புதுப்பிப்புகளுக்கு பின்னர் பார்க்கவும்',
    // Month Names
    'January': 'ஜனவரி',
    'February': 'பிப்ரவரி',
    'March': 'மார்ச்',
    ...
    // Activity Types
    'Events': 'நிகழ்வுகள்',
    'Gram Sabha': 'கிராம சபை',
    'Scheme Deadlines': 'திட்ட காலக்கெடுக்கள்',
    'Works': 'பணிகள்',
    'Polls': 'வாக்கெடுப்புகள்',
    'Event': 'நிகழ்வு',
    'Poll': 'வாக்கெடுப்பு',
    'Poll Ends': 'வாக்கெடுப்பு முடிவு',
    'Scheme Deadline': 'திட்ட காலக்கெடு',
    'Work Start': 'பணி தொடக்கம்',
    'Work Completion': 'பணி நிறைவு',
    'Deadline': 'காலக்கெடு',
    'Start': 'தொடக்கம்',
    'Completion': 'நிறைவு',
    'Legend': 'குறியீடு',
